...
const Hireme = () => {
  ...
  return <section className="bg-bg-light-primary">
    <div className="md:container px-5 pt-14">
      ...
      <div className="flex items-center md:flex-row flex-col-reverse">
        ...
        <div data-aos="fade-left" className="border-2 border-dark_primary max-w-sm p-6 shadow-sm rounded-xl rounded-br-[8rem]
        sm:min-w-[22rem]">
          <p className="leading-7">{Hireme.para}</p>
          <br/>
          <a href="tel:004915734651375">
